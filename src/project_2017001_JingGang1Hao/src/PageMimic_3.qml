...
Rectangle{
    ...
    Text{
        ...
        property var dataItem: dataSource.getValue(0x020001A3)
    ...
    Text{
        ...
        property var dataItem: dataSource.getValue(0x020001A4)
        text: dataItem.tagValue.toFixed(1)
    }
    Text{
        id:tempW
        ...
        property var dataItem: dataSource.getValue(0x020001A5)
        text: dataItem.tagValue.toFixed(1)
    }
}
